...
That's one huge dataframe - 277,240 rows. I understand that this should be stored on a SQL server, but Rstudio can still handle this sized data so I'm keeping it here for now. 

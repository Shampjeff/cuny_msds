...
**There is a clear peak at around 1550, but the data looks to be far from normal. I used a point estimate of the sample as a metric for population mean. That mean is 1542.**

2.  Would you expect another student's distribution to be identical to yours? 
Would you expect it to be similar? Why or why not?

**That would not be identical, but they would be similar in that they both would be hard to describe as a known function.**
...
**CLT must apply- success/failure condition, independence, and substitute approximation.**

## Confidence levels

4.  What does "95% confidence" mean? If you're not sure, see Section 4.2.2.

**We can be 95% sure that our sample proportion is the most likely value for the population proportion. In this case, the sample mean is the most likely value to estimate the true mean.**
...
**In a class of 25, I wouldn't be surprised if no one had a CI that _did not_ capture the mean. Maybe, there would be one person. In a class of 100, there would likely be a few.**
...
**It may not be exactly five because there is an element of randomness to the sampling so things don't always work out as 5 in 100.**
...
**90% confidence has a critical value of 1.645. Just calculate a Z-score that cooresponds to your desired CI.**
...
**As expected, to some extent, we got more CI with means that don't capture the true mean.**

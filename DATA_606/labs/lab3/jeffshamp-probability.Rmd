...
**Kobe's actual streak distribution has a median of 0 and the number of consecutive shots drops off by 4, where as in both simulations the max streak length is either higher (5 or 7) or has less miss streaks and more hit streaks of all values. That's a big difference in terms of streaks. This suggests that the hot hand theory, does not have much merit. We would like to think our confidence can *will* the the ball in the basket, but I don't there is much behind that**

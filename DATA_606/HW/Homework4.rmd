...
$\sigma = \sqrt(\frac{1-0.02}{0.02^{2}}) = 49.49$. Given these equations, the standard deviation with always be very close in value to the mean. That kind of makes me think that the mean and sd are not so meaningful. 
